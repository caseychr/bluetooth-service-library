...
public class BluetoothConnector {
    ...
    private BluetoothConnector.ConnectThread mConnectThread;
    private BluetoothConnector.ConnectedThread mConnectedThread;
    private int mState;
    ...
    public synchronized void connect() {
        ...
        mConnectThread = new BluetoothConnector.ConnectThread();
    ...
    public synchronized void connected(BluetoothSocket socket, final String socketType) {
        ...
        mConnectedThread = new BluetoothConnector.ConnectedThread(socket, socketType);
        mConnectedThread.start();

        // Send the name of the connected device back to the UI Activity
        Message msg = mConnectionHandler.obtainMessage(BluetoothController.MESSAGE_DEVICE_NAME);
    ...
    public void write(byte[] out) {
        ...
        BluetoothConnector.ConnectedThread r;
    ...
    private void connectionFailed() {
        ...
        Message msg = mConnectionHandler.obtainMessage(BluetoothController.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
            ...
            while (true) {
                try {
                    ...
                    for (int i = 0; i < s.length(); i++) {
                        ...
                        //if (x == 0x3e) {
                        if (msg.contains(">")) {
                            mConnectionHandler.obtainMessage(BluetoothController.MESSAGE_READ, buffer.length, -1, msg).sendToTarget();
                            msg = "";
                        }
                    }
